...
public class MembersController : ControllerBase
{
    ...
    /// <summary>
    /// Meses adeudados: cuenta, desde el mes de alta del socio hasta el mes
    /// actual (ambos inclusive), cuántos de esos meses no tienen un pago
    /// registrado en MemberPayments. Un socio recién dado de alta ya debe el
    /// mes en curso hasta que se le cobre esa primera cuota.
    /// </summary>
    private static int MonthsOwed(Member member, IEnumerable<MemberPayment> payments)
    {
    ...
    {
        var monthsOwed = MonthsOwed(m, payments);
        return new
        {
            id = m.Id,
            name = m.Name,
