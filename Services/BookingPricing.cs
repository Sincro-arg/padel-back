...
public static class BookingPricing
{
    ...
    public static async Task<(decimal? total, string? error)> CalculatePriceAsync(AppDbContext db, DateOnly date, int startHour, int endHour, decimal discountPercent = 0)
    {
